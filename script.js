const ramos = {
  ...
  // --- QUINTO AÑO ---
  "Internado": [] // Requiere todos los ramos anteriores aprobados, se controla en la UI
};
...
function renderMalla() {
  ...
  for (const [año, semestres] of Object.entries(ordenSemestres)) {
    ...
    // Agregar clase según el año para colores pastel
    ...
    for (const [nombreSemestre, ramosLista] of semestres) {
      ...
      ramosLista.forEach(nombre => {
        ...
        // Control para Internado: requiere todos aprobados antes
        if (nombre === "Internado") {
